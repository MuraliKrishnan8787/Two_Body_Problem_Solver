...
m1, m2 = float(massin[0]), float(massin[1])

rinp = input("Enter initial position of mass 1 in x, y coordinates seperated by space, assuming com as origin :").split(" ")
r01 = np.array([float(rinp[0]), float(rinp[1])])

Rinp= input("Enter the radii for the two planets: ").split(" ")
R1,R2 = float(Rinp[0]),float(Rinp[1])

vinp = input("Enter velocitiy vector of mass 1 in x, y coordinates seperated by space, assuming com as origin :").split(" ")
